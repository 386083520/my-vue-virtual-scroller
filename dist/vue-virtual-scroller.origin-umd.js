  ...
  var script$2 = {
    ...
    watch: {
      items: function items() {
        console.log('gsditems')
        this.updateVisibleItems(true);
      },
      pageMode: function pageMode() {
        console.log('gsdpageMode')
        this.applyPageMode();
        this.updateVisibleItems(false);
      },
      sizes: {
        handler: function handler() {
          console.log('gsdsizes')
          this.updateVisibleItems(false);
        },
        deep: true
      }
  ...
  var script = {
    ...
    methods: {
      updateSize: function updateSize() {
        if (this.finalActive) {
          console.log('gsdupdateSize', this.$_pendingSizeUpdate, this.id)
      ...
      computeSize: function computeSize(id) {
        ...
        this.$nextTick(function () {
          console.log('gsdcomputeSize', _this3.id, id)
          if (_this3.id === id) {
      ...
      applySize: function applySize(width, height) {
        ...
        console.log('gsdsize', this.size, size)
